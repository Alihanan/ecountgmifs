...
nb2_loglik_cpp <- function(y, mu, dispersion, mu_min_cap, mu_max_cap, poisson_fallback_eps) {
    .Call(`_ecountgmifs_nb2_loglik_cpp`, y, mu, dispersion, mu_min_cap, mu_max_cap, poisson_fallback_eps)
}
